...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		w.Write([]byte("Falaha ao ler o corpo da requissição"))
		return
	}
...
//Buscar usuário traz um usuário específico salvo no banco de dados
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		w.Write([]byte("Erro ao criar os statement!"))
		return
	}
	defer statement.Close()
